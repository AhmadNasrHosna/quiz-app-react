  ...
  return (
    <>
      ...
      <div className="c-statistics">
        ...
        <p>
          <strong>Quiz:</strong>{" "}
          {initialStatistics.category[1] +
            " | " +
            initialStatistics.difficulty.split("")[0].toUpperCase() +
            initialStatistics.difficulty.split("").splice(1).join("")}
        </p>
        <p>
          <strong>Your Score:</strong> {initialStatistics.score}/10
        </p>
        <p>
          <strong>Time Duration:</strong> {initialStatistics.time}
        </p>
        <ShareIcons
          title={`${initialStatistics.category[1]} Quiz Score: ${initialStatistics.score}/10`}
        />
        <p>
